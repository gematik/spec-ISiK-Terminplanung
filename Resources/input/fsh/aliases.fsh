...
Alias: $IHEpracticeSettingVS = http://ihe-d.de/ValueSets/IHEXDSpracticeSettingCodeDoctoral
Alias: $IHEpracticeSettingCS = http://ihe-d.de/CodeSystems/AerztlicheFachrichtungen
